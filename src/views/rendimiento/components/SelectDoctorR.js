...
import { setUserRendimiento } from '../../../store/slices/rendimiento/userRendimiento.slice'

const SelectDoctorR = ({visible, setVisible}) =>{
                                ...
                                return(
                                    <CustomRadioButton
                                        ...
                                        onPress={()=>{
                                            ...
                                            dispatch(setUserRendimiento(doctor))
                                        }}
                                    />
                                )
                            } )
